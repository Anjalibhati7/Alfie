    ...
    <Screen>
      ...
      >
        ...
        {!latest ? (
          <View style={styles.empty}>
            ...
            <Copy style={ui.secondary}>
              Start a Discover or Reimagine session and it will be recorded
              here.
            </Copy>
          </View>
        ) : (
        ...
        <View style={styles.block}>
          ...
          {thoughts.length === 0 ? (
            <Copy style={ui.secondary}>
              Use “Save a thought or discovery” during a session and it will
              find a place here.
            </Copy>
          ) : (
        ...
        {latest && (
          <>
            ...
            <View style={styles.block}>
              ...
              <Copy kind="label" style={ui.secondary}>
                Deleting a session removes its themes and route from this
                device.
              </Copy>
